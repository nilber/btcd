...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/nilber/btcd/btcutil/coinset)
...
```bash
$ go get -u github.com/nilber/btcd/btcutil/coinset
```

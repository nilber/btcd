...
* Download the Conformal public key:
  https://raw.githubusercontent.com/nilber/btcd/master/release/GIT-GPG-KEY-conformal.txt
...
* Install the MSI available at: [btcd windows installer](https://github.com/nilber/btcd/releases)
...
```bash
git clone https://github.com/nilber/btcd $GOPATH/src/github.com/nilber/btcd
...
* [Using bootstrap.dat](https://github.com/nilber/btcd/blob/master/docs/configuration.md#using-bootstrapdat)

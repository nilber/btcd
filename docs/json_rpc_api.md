...
* Unlike bitcoind that has the wallet and chain intermingled in the same process
  ...
  [btcwallet](https://github.com/nilber/btcwallet).
...
such as [btcwallet](https://github.com/nilber/btcwallet) for inter-process
...
[rpcclient](https://github.com/nilber/btcd/tree/master/rpcclient) package.
...
[rpcclient](https://github.com/nilber/btcd/tree/master/rpcclient) package to connect with

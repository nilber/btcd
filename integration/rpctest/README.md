...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](https://pkg.go.dev/github.com/nilber/btcd/integration/rpctest)
...
```bash
$ go get -u github.com/nilber/btcd/integration/rpctest
```

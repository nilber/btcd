...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](https://pkg.go.dev/github.com/nilber/btcd/peer)
...
```bash
$ go get -u github.com/nilber/btcd/peer
```

## Examples

* [New Outbound Peer Example](https://pkg.go.dev/github.com/nilber/btcd/peer#example-package--NewOutboundPeer)  
